...
# Create a new data frame without rows where 'Cell_type...128' has value "Unkown"
...
# Keep a copy for safety and ease of use
...
#  Linear Discriminant Analysis
  A method you can use when you have a set of predictor variables and you’d like to classify a response variable into two or more classes.
...
```{r}
# Assuming 'predictions_xgb' is a data frame or a tibble containing the predictions
# and 'test_n' is your test data
